...
class DatassController extends Controller
{
    ...
    {  
        ...
        return view(
            ...
            ["dataGrafico" => json_encode($puntos),"dataAtalaya" => json_encode($puntosAtalaya)
            ,"dataCrnlPortillo" => json_encode($puntosCrnlPortillo)
            ,"dataPadreAbad" => json_encode($puntosPadreAbad)
            ,"dataPurus" => json_encode($puntosPurus)],
