...
class SiafWebRPT7Export implements FromView, ShouldAutoSize, WithEvents
{
    ...
    public function __construct($ano, $articulo, $ue, $ff, $gg, $sg)
    {
        $this->ano = $ano;
    ...
    {
        $body = BaseSiafWebRepositorio::listar_subgenerica_anio_acticulo_ue_categoria($this->ano, $this->articulo, $this->ue, $this->ff, $this->gg, $this->sg);
