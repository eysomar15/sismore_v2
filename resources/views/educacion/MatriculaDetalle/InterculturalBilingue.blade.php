            ...
            <div class="col-lg-12">
                <div class="card card-fill bg-primary  mb-0">
                    <div class="card-header bg-transparent">
                        <h3 class="card-title text-white text-center">EDUCACION INTERCULTURA BILINGUE (EIB) SEGÚN SIAGIE- MINEDO
                    ...
                    <div class="card-body">
                        <form id="form_opciones" name="form_opciones" action="POST">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <label class="col-md-1 col-form-label">Área Geografica</label>
                                <div class="col-md-2">
