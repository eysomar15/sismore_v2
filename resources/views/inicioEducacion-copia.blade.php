        ...
        $(document).ready(function() {
            ...
            @if ($importacion_id)
                gSimpleColumn('anal1', <?= $info['g1'] ?>,
                    'Estudiantes Matriculados por Años', 'Fuente:SIAGIE', '');

                gSimpleColumn('anal2', <?= $info['g2'] ?>,
                    'Personal Docente por Años ', 'Fuente:NEXUS', '');

                gPie('anal3', <?= $info['g3']['pts'] ?>,
                    'Estudiantes Matriculados según Genero', 'Fuente:SIAGIE <?= $info['g3']['anio'] ?>', '');
                gPie('anal4', <?= $info['g4']['pts'] ?>,
                    'Personal Docente según Genero', 'Fuente:NEXUS <?= $info['g4']['anio'] ?>', '');
